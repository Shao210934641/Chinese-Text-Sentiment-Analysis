...
* After opening *main.ipynb*, please first complete STEP 1- 4 at the top of the file (please do not run *main.ipynb* directly or you will get compatibility errors).  
