...
You need to use Google Colab platform. You don't need to download the file, just open the main.ipynb file in the link below and follow the instructions in it to run it on Google Colab.(Please do not run the main.ipynb directly or you will get compatibility errors)  
